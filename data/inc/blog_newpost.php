...
<input type=\"button\" name=\"Cancel\" value=\"$lang_install14\" onclick=\"javascript: window.location='?editblog=$cat';\">
</form>";
...
if (file_exists("data/blog/$cat/posts/post1.php")) {
$i = 2;
$o = 3;
while ((file_exists("data/blog/$cat/posts/post$i.php")) || (file_exists("data/blog/$cat/posts/post$o.php"))) {
$i = $i+1;
$o = $o+1; }
$newfile = "data/blog/$cat/posts/post$i.php";
$filename = "post$i"; }
else {
$newfile = "data/blog/$cat/posts/post1.php";
$filename = "post1";
}
$data = $newfile;
...
?>");
fclose($file);
mkdir ("data/blog/$cat/reactions/$filename");
chmod ("data/blog/$cat/reactions/$filename", 0777);
