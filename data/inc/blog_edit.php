...
<table>
	<tr>
		...
		<td>
			<span style=\"font-size: 17pt;\"><a href=\"?action=blog_newpost&cat=$editblog\">$lang_blog10</a></span>
		</td>
	</tr>
</table>
</div>";
...
read_blog_posts("data/blog/$editblog/posts");

echo "<p><a href=\"?action=blog\"><<< $lang_theme12</a></p>";
?>