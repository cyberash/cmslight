...
if (is_writable($file)) {
	echo "<tr><td>/$file &nbsp;"; 
	echo "<td><img src=\"data/image/true.gif\" width=\"15\" height=\"15\" alt=\"$lang_install8\"></td></tr>";
	}
	else {
	echo "<tr><td>/$file &nbsp;"; 
	echo "<td><img src=\"data/image/false.gif\" width=\"15\" height=\"15\" alt=\"$lang_install9\"></td></tr>"; 
	}
}
...
if(($file !== ".") and ($file !== "..") and ($file !== "langpref.php") and ($file !== "en.php")) {
   if(is_file($dir."/".$file))
        $files[]=$file;
   else
        $dirs[]=$dir."/".$file;           
...
echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"0; URL=?action=install3\">";
}
include ("data/inc/footer.php");
}

//Installation Step 3: Sitetitle
if ($action == "install3") {
$titelkop = $lang_install;
include ("data/inc/header2.php");
echo "<span class=\"kop2\">$lang_install :: $lang_install6</span><br>";
echo "<p><b>$lang_install12</b></p>";

echo "<form method=\"post\" action=\"\">
<span class=\"kop2\">$lang_install17</span><br>
<input name=\"cont\" type=\"text\" value=\"\"><br>
<input type=\"submit\" name=\"Submit\" value=\"$lang_install13\"><input type=\"button\" name=\"Cancel\" value=\"$lang_install14\" onclick=\"javascript: window.location='?action=install2';\">
</form>"; 
...
<textarea name=\"cont2\" cols=\"70\" rows=\"20\"></textarea><br>
...
//Delete temporary packaging-files, and make some dirs for the trashcan and modulesettings
